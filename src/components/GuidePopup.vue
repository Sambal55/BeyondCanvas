...
const guideText =
  'Welkom! Scroll over het schilderij om de omgeving te verkennen.\n' +
  'Voel je een trilling? Er is informatie te lezen op het scherm.\n' +
  'Hoor je "Eind"? Dan heb je de rand van het schilderij bereikt.\n' +
  'De balk bovenaan toont hoeveel informatiepunten je al hebt gezien.\n' +
  'Gebruik de terugknop (boven) om naar het hoofdmenu te gaan.'
